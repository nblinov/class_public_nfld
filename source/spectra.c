...
int spectra_indices(
  ...
  class_define_index(psp->index_tr_delta_ur_fld,ppt->has_source_delta_ur_fld,index_tr,1);
  ...
  class_define_index(psp->index_tr_theta_ur_fld,ppt->has_source_theta_ur_fld,index_tr,1);
...
int spectra_output_tk_titles(struct background *pba,
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_density_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"d_ur_fld",pba->has_ur_fld);
      if (pba->has_ncdm == _TRUE_) {
        for (n_ncdm=0; n_ncdm < pba->N_ncdm; n_ncdm++) {
    ...
    if (ppt->has_velocity_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"t_ur_fld",pba->has_ur_fld);
      if (pba->has_ncdm == _TRUE_) {
        for (n_ncdm=0; n_ncdm < pba->N_ncdm; n_ncdm++) {
    ...
    for (index_k=0; index_k<psp->ln_k_size; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[psp->index_tr_delta_ur_fld],ppt->has_source_delta_ur_fld,storeidx);
          if (pba->has_ncdm == _TRUE_){
            for (n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++){
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[psp->index_tr_theta_ur_fld],ppt->has_source_theta_ur_fld,storeidx);
          if (pba->has_ncdm == _TRUE_){
            for (n_ncdm = 0; n_ncdm < pba->N_ncdm; n_ncdm++){
        ...
        class_store_double_or_default(dataptr,-tk[psp->index_tr_delta_ur_fld]/k2,ppt->has_source_delta_ur_fld,storeidx,0.0);
