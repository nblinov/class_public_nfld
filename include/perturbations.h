...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_ur_fld; /**< do we need source for delta of non-freestreaming ultra-relativistic neutrinos/relics? */
  ...
  short has_source_theta_ur_fld; /**< do we need source for theta of non-freestreaming ultra-relativistic neutrinos/relics? */
  ...
  int index_tp_delta_ur_fld; /**< index value for delta of non-freestreaming ultra-relativistic neutrinos/relics */
  ...
  int index_tp_theta_ur_fld;   /**< index value for theta of non-freestreaming ultra-relativistic neutrinos/relics */
...
struct perturb_vector
{
  ...
  int index_pt_delta_ur_fld; /**< density of non-freestreaming ultra-relativistic neutrinos/relics */
  int index_pt_theta_ur_fld; /**< velocity of non-freestreaming ultra-relativistic neutrinos/relics */
/* perturbed recombination */
