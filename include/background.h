...
struct background
{
  ...
  double Omega0_ur_fld; /**< \f$ \Omega_{0 \nu r} \f$: non-freestreaming ultra-relativistic species */
  ...
  int index_bg_rho_ur_fld;        /**< non-freestreaming relativistic neutrinos/relics density */
  ...
  short has_ur_fld;        /**< presence of non-freestreaming ultra-relativistic neutrinos/relics? */
